...
public class MealsUtil {
    ...
    public static final int DEFAULT_MEAL_CALORIES = 1000;

    public static List<MealWithExceed> getWithExceeded(Collection<Meal> meals, int caloriesPerDay) {
        return getFilteredWithExceeded(meals, meal -> true, caloriesPerDay);
    }

    public static List<MealWithExceed> getFilteredWithExceeded(Collection<Meal> meals, Predicate<Meal> predicate, int caloriesPerDay) {
    ...
    public static List<MealWithExceed> getFilteredWithExceeded(Collection<Meal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        return getFilteredWithExceeded(meals, meal -> DateTimeUtil.isBetween(meal.getTime(), startTime, endTime), caloriesPerDay);
    }
